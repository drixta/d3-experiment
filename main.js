!function(){
	...
	var data = [
		[
			{axis: 'Calculus', value: 0.75},
			{axis: 'Geometry', value: 0.45},
			{axis: 'Trigonometry', value: 0.24},
			{axis: 'Equation', value: 0.63},
			{axis: 'Math1', value: 0.53},
			{axis: 'Math2', value: 0.53},
			{axis: 'Math3', value: 0.53},
		],
	];
